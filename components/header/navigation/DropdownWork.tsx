...
export function DropdownWork({ closeDropdown, isDropdownOpen }: DropDownProps) {
   ...
   return (
      <nav
         ref={dropdownRef}
         className="absolute left-1/2 top-10 flex h-72 w-96 -translate-x-1/2 -translate-y-2 transform justify-between gap-4 rounded-md border border-primary_light/50 bg-primary_dark/80 p-4 opacity-0 backdrop-blur-lg z-[10000]"
